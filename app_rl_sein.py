...
"(Ces variables sont à déterminer à partir de mesure faites sur les noyaux des cellules tumorales durant l'anapath)")    
...
area_se = st.number_input("area_se", min_value=0.0, max_value=550.0, value=0.0, step=50.0)
texture_worst = st.number_input("Texture worst", min_value=0.0, max_value=50.0, value=0.0, step=1.0)
